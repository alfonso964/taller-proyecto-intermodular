...
import { detallesServicios } from "../datos/serviciosDetalles"; 
      ...
      <div className="contenido-servicios">
        ...
        <section className="servicios-cta-ia">
          <div className="cta-ia-card">
            ...
            <Link to="/reserva-ia" className="boton-ir-ia">
              Consultar con nuestra IA
            </Link>
          </div>
        </section>

        <section className="contenedor-garantias">
          <div className="tarjeta-garantia">
            <FaShieldHalved className="garantia-icono" />
            <h4>Garantía Total</h4>
            <p>12 meses en todas las piezas y mano de obra para tu tranquilidad.</p>
          </div>
          <div className="tarjeta-garantia">
            <FaClockRotateLeft className="garantia-icono" />
            <h4>Servicio Rápido</h4>
            <p>Optimizamos procesos para que recuperes tu vehículo en tiempo récord.</p>
          </div>
          <div className="tarjeta-garantia">
            <FaMedal className="garantia-icono" />
